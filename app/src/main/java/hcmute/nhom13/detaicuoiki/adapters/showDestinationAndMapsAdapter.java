...
//Adapter hiển thị list các trạm dừng của 1 tuyến
public class showDestinationAndMapsAdapter extends BaseAdapter {
    ...
    public  showDestinationAndMapsAdapter(Context context, int layout, ArrayList<busStopModel> busStopList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        showDestinationAndMapsAdapter.ViewHolder holder;

        //Khởi tạo và kiểm tra view
        if(view == null) {
            holder = new showDestinationAndMapsAdapter.ViewHolder();
            ...
            holder = (showDestinationAndMapsAdapter.ViewHolder) view.getTag();
        }
